...
(function() {
    var mod = angular.module('mappings.edit', []);

    mod.controller('MappingsEditController', MappingsEditController);

    function MappingsEditController($scope, $http, $stateParams, $state, mapping, mime_types, types) {
